...
### 3-3. 협업: ESLint, Wiki 등을 활용하여 팀으로 작업해도 코드 퀄리티가 유지되게 노력했다.
...
- 프로젝트 발표
    ...
    - 팀원들에게 소감 취합: 팀원들마다 배운 점, 해결한 점, 소감을 모아서 이를 발표에 녹임.
    - 딜리버리 연습: 6분 내에 데모와 프로젝트 설명을 전부 맞춰야해서, 발표 전 시간을 초과하지 않도록 연습
